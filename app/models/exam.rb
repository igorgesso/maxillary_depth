class Exam < ApplicationRecord
  ...
  belongs_to :point_n, class_name: "Point", foreign_key: 'point_n_id', dependent: :destroy
  belongs_to :point_a, class_name: "Point", foreign_key: 'point_a_id', dependent: :destroy
